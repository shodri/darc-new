...
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-row">
                    ...
                    <input type="text" class="form-control" name="button" value=""" required>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-row">
                    ...
                    <input type="url" class="form-control" name="href" value="" required>
                </div>
            </div>
        </div>
    ...
    {{-- <div class="card p-3">
        <form method="POST" action="{{ route('admin.albums.upload', $album->id) }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <x-adminlte-input-file name="before_crop_image_xs" id="before_crop_image_xs" label="Subir Imagen"
                    placeholder="Seleccione una imagen..." />
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var $image_crop = $('#image_demo').croppie({
                enableExif: true,
                viewport: {
                    width: 1600 / 2 , // Ajustar al ancho de la imagen final
                    height: 670 / 2, // Ajustar al alto de la imagen final
